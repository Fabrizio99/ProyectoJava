...
import javax.swing.*;
public class VentanaRegistroFutbolista extends javax.swing.JFrame {
    ...
    public VentanaRegistroFutbolista() {
        initComponents();
    ...
    public void listaActualizada(){
        ...
        for (int i = 0; i < VentanaRegistroEntrenadores.listaEntrenadores.size(); i++) {
            cmbEntrenador.addItem(VentanaRegistroEntrenadores.listaEntrenadores.get(i).getNombre());
        }
        cmbMasajista.removeAllItems();
        cmbMasajista.addItem("");
        for (int i = 0; i < VentanaRegistroMasajista.listaMasajistas.size(); i++) {
            cmbMasajista.addItem(VentanaRegistroMasajista.listaMasajistas.get(i).getNombre());
        }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if(btnGuardar.getText().equals("Agregar")){
            if(VentanaRegistroEntrenadores.listaEntrenadores.isEmpty() || VentanaRegistroMasajista.listaMasajistas.isEmpty()){
                JOptionPane.showMessageDialog(null, "Debe registrar a entrenadores y/o masajistas para poder registrar al futbolista");
            }else{
            ...
            if(campoNombre.getText().equals("")||campoApellido.getText().equals("")||campoDemarcacion.getText().equals("")
                ...
                if(VentanaPrincipal.validarRegistroID(campoID.getText())){
                    JOptionPane.showMessageDialog(null, "Ya existe una persona con ese DNI");
                }else if(VentanaPrincipal.validarLongitudID(campoID.getText())){
                    ...
                    VentanaPrincipal.registroID.add(campoID.getText());
